...
//Fetch the requested post from mediaPost table
$postId = mysqli_real_escape_string($conn, $_GET['postId']);

$sql= "SELECT * FROM mediaPost WHERE postID ='$postId'";
...
if(mysqli_num_rows($result) > 0){
      ...
      $row = mysqli_fetch_assoc($result);
	     ...
	     if ($extension == 'jpg' || $extension == 'jpeg' || $extension == 'png') {
	        	$resources = "<img src='./document/$profile' width='100%' height='100%' style='border-radius: 6px;'>";
	       }else{
	       	    $resources = "<video src='./document/$profile' width='100%' height='100%' style='border-radius: 6px;' controls></video>";
	       }  

  }else{
		echo "<p style='position: absolute;transform: translate(-50%, -50%);top: 50%;left: 50%;'>No record found !</p>";
  }
...
<body>
	...
	<div id="parent">
		...
		<div id="view-main">
			...
			<div id="post-content-div">
				  <div id="media-resource-div">
				  	<!--Resourecs like images, videos, audios, zip files will be placed here-->
				  	<?php echo $resources; ?>
				  </div>
			   ...
			   <div id="comment-section">
			   	   ...
			   	   <div id="comment-scroll-div">
			   	   		...
			   	   		<?php
				   	   	 ...
				   	   	 //$sql = "SELECT * FROM media_comments WHERE postID = '$postId' AND status = 'approved'";  Use this line during launch !!!
			   	   		 $sql = "SELECT * FROM media_comments WHERE postID = '$postId'";
			             $query = mysqli_query($conn, $sql);
			              ...
			              if(mysqli_num_rows($query) > 0){
							  ...
							  while ($row = mysqli_fetch_assoc($query)) {
		                          ...
		                          echo "<p style='position: absolute;transform: translate(-50%, -50%);top: 50%;left: 50%;'>No comment found for this post. Be the first to comment</p>";
							}*/
		             ...
		             ?>
				   	   	...
				   	   	<form class="comment-form" id="comment-form">
				   	   		<input type="email" name="email" id="post-email" class="name-input" placeholder="Enter email here.." required>
				   	   		<textarea id="comment-text" name="comment" placeholder="Type a comment.." required></textarea>
				   	   		<input type="hidden" name="postId" value="<?php echo $postId; ?>">
				   	   		<button type="submit" class="post-comment" id="post-button">Comment</button>
				   	   	</form>
	  ...
	  <script src="js/like-media-post.js"></script>
	  <script src="js/post-media-comment.js"></script>
