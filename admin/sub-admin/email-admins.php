...
try {
    ...
    $sql = "SELECT email FROM members WHERE role='admin'"; //If this does not work, use only members table, then include the general email address so that all leaders will see it
