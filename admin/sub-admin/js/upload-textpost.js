 ...
 function refresh() {
  ...
  function uploadTextpost() {
            ...
            //Initialize HTTP request to server
             ...
             var url = "upload-textpost.php";
             var form = new FormData(document.getElementById('text-post-form'));
    ...
    var form = document.getElementById('text-post-form');
