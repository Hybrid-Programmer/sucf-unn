    var left = document.getElementById("left");
     ...
     var messageForm = document.getElementById("message-all-form");
 ...
 function refresh() {
  ...
  function emailAllMembers() {
            ...
            //Initialize HTTP request to server
             ...
             var url = "email-all.php";
             var form = new FormData(document.getElementById('message-all-form'));
    ...
    var form = document.getElementById('message-all-form');
