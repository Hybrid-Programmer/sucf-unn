 ...
 var messageForm = document.getElementById("message-admin-form");
 var messageTextarea = document.getElementById("message-textarea1");
 ...
 function refresh() {
  ...
  function emailAdmins() {
            ...
            //Initialize HTTP request to server
             ...
             var url = "email-admins.php";
             var form = new FormData(document.getElementById('message-admin-form'));
    ...
    var form = document.getElementById('message-admin-form');
