...
require 'conn.php';
 ...
 $sql= "SELECT * FROM timer ORDER BY timerID DESC LIMIT 1";
...
<script  src='js/jQuery.js'></script>
    <script type='text/javascript'>
      ...
      document.querySelector('.event-images').addEventListener('click', function () {
        window.location = 'upcoming-events.html';
     })
